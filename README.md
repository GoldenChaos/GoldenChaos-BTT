...
## Screenshots
{% include image.html url="https://github.com/GoldenChaos/GoldenChaos-BTT/blob/master/screenshot-1.png" description="The default set of keys" %}
{% include image.html url="https://github.com/GoldenChaos/GoldenChaos-BTT/blob/master/screenshot-2.png" description="Contextual buttons and widgets appear and disappear as you open/close corresponding apps" %}
{% include image.html url="https://github.com/GoldenChaos/GoldenChaos-BTT/blob/master/screenshot-4.png" description="Critically, the esc/fullscreen key stays docked to the left at all times" %}
{% include image.html url="https://github.com/GoldenChaos/GoldenChaos-BTT/blob/master/screenshot-4.png" description="Widgets for Reminders, Fantastical, Things 3, and more apps added on a regular basis" %}
![Screenshot](https://github.com/GoldenChaos/GoldenChaos-BTT/blob/master/screenshot-5.png?raw=true)
{% include image.html url="https://github.com/GoldenChaos/GoldenChaos-BTT/blob/master/screenshot-6.png" description="Emoji and app switcher widgets take over the scrollable container" %}
{% include image.html url="https://github.com/GoldenChaos/GoldenChaos-BTT/blob/master/screenshot-7.png" description="Hold down alt/option to expand the control strip" %}
